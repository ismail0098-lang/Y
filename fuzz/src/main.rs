...
// Third copy of the witness solver removed: it now lives in y::zk_witness so
// this binary, fuzz_zk_soundness and tests/zk_groth16_end_to_end all exercise
// ONE implementation. Three divergent solvers meant three different answers to
