...
__device__ void std_mod_mul(u64* res, const u64* a, const u64* b) {
    u64 R2[4] = {0x1bb8e645ae216da7ULL, 0x53fe3ab1e35c59e3ULL, 0x8c49833d53bb8085ULL, 0x0216d0b17f4e44a5ULL};
    u64 tmp[4];
    cios_mont_mul(tmp, a, b);
    cios_mont_mul(res, tmp, R2);
}

extern "C" __global__ void test_std_mul_kernel(u64* out, const u64* A, const u64* B) {
