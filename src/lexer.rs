...
mod tests {
    ...
    fn test_unexpected_eof() {
        // The codebase emits a malformed StringLit token containing the text up to the EOF,
        // rather than a dedicated error token, when an unexpected EOF occurs during string lexing.
