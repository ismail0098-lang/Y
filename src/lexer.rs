...
mod tests {
    ...
    #[test]
    fn test_unterminated_string_error_explicit() {
        // The codebase gracefully handles unexpected EOF in strings by emitting a
        // malformed StringLit containing the text up to EOF rather than a dedicated error.
