...
mod tests {
    ...
    fn test_unexpected_eof_string() {
        // The codebase gracefully handles EOF during string lexing by emitting
        // a malformed StringLit token containing the text up to the EOF, rather than a dedicated error token.
