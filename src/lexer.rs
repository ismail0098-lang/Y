...
mod tests {
    ...
    #[test]
    fn test_unexpected_eof_string_lexer() {
        // The codebase handles an unexpected EOF during string lexing by emitting a malformed
        // TokenKind::StringLit token containing the text up to the EOF, rather than a dedicated error token.
