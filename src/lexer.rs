...
mod tests {
    ...
    fn test_unterminated_string_basic() {
        // The codebase gracefully handles an unexpected EOF in string lexing by
        // emitting a malformed `TokenKind::StringLit` token instead of a dedicated error token.
