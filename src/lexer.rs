...
mod tests {
    ...
    fn test_unexpected_eof() {
        // The codebase handles unexpected EOF during string lexing by emitting a
        // malformed StringLit token containing the text up to EOF instead of an error token.
