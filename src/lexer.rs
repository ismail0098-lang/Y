...
mod tests {
    ...
    fn test_error_unexpected_eof() {
        // The codebase handles unexpected EOF during string lexing by emitting a malformed TokenKind::StringLit containing the text up to the EOF, rather than an error token.
