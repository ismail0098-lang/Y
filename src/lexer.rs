...
mod tests {
    ...
    fn test_unexpected_eof_string() {
        // The prompt asks to verify if an unterminated string returns an error or a malformed token.
        // In this local codebase, it returns a malformed TokenKind::StringLit containing the text up to EOF.
