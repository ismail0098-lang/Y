...
mod tests {
    ...
    fn test_error_unexpected_eof() {
        // The codebase gracefully handles unexpected EOF in strings by emitting a malformed StringLit token containing the text up to the EOF, rather than an explicit error token.
