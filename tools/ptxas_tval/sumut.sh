...
row "S11 the doc drops the -O1 sole-blocker claim" ../../docs/ptxas_translation_validation.md "$(sub "\"kernels one blocker\naway are\"" "\"kernels, one of which is a blocker\naway, are\"")"
row "S12 the doc's -O3 distinct figure goes stale" ../../docs/ptxas_translation_validation.md "$(sub "\"**106** distinct blockers; at\"" "\"**103** distinct blockers; at\"")"
